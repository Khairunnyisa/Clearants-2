      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between py-5 px-8 xl:px-0">
        ...
        <div className="hidden md:flex items-center gap-8 font-medium">
          ...
          <div className="relative group">
            <span
              className={`${linkColor} cursor-pointer inline-flex items-center gap-1 relative`}
            >
              Solutions
              <svg
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    {MODULE_ITEMS.map((item) => (
                      <button
                        ...
                        className={`text-left ${item.colSpan || ""} relative group`}
                      >
        ...
        <div className="hidden md:flex">
          <button
            className={`px-7 py-3 rounded-lg text-sm font-medium ${isHeroStyle ? "bg-white text-black" : "bg-black text-white"}`}
          >
            Request Live Demo
          </button>
        </div>
      ...
      {open && (
        <div className="md:hidden bg-black/95 backdrop-blur-md px-8 py-6">
          <div className="flex flex-col gap-6 text-white font-medium">
            ...
            <a href="/asoc" onClick={() => setOpen(false)}>
              ASOC
            </a>
            <a href="/article" onClick={() => setOpen(false)}>
              Article
            </a>
